...
class Dheeraj():
    ...
    temp_dir=os.getcwd()
    if path.isdir("Dheeraj_Downloads")==True:
        pass
    else:
        os.system('mkdir Dheeraj_Downloads')
    if path.isdir('Dheeraj_Uploads')==True:
        pass
    else:
        os.system('mkdir Dheeraj_Uploads')
    os.chdir(temp_dir)
    ...
    def welcome(self):
        ...
        time.sleep(0.1)
        cprint(" Welcome to Secure Dheeraj Server!",'red',attrs=['bold'],file=sys.stderr)
        print("")
        print("")
    ...
    def logincred(self):
        ...
        if answers['log']=='Login':
            ...
            time.sleep(0.95)
            cprint(" You have been successfully registrated to the Secure Dheeraj Server, hooray!","yellow")
            time.sleep(1)
            self.logincred()
    ...
    def chatselector(self):
        ...
        chatroom=input(" Enter the Dheeraj chatroom name you want to join: ")
    
        if chatroom in self.chatrooms:
            print("")
        else:
            cprint(" You've succesfully created a new Dheeraj chatroom! Good luck!","red")
            time.sleep(1)
        ...
        if chatroom in self.chatrooms:
            ...
            cprint(" There is no Dheeraj chatroom with the name you entered :( )")
            print("")
            time.sleep(0.2)
            self.clear()
            self.chatselector()    
    ...
    def getInput(self):
        ...
        if message=="send file" or message=="sdf":
            ...
            os.chdir(os.getcwd()+'\\Dheeraj_Uploads')
            time.sleep(0.5)
            print("")
            os.system('dir')
            print("")
        ...
        if message=='download file' or message=='ddf':
            os.chdir(os.getcwd()+'\\Dheeraj_Downloads')
            import filestransfer
